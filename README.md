...
基于 [TaskPilot](https://github.com/YUANXICHE98/TaskPilot) 的智能任务拆解系统，能够将复杂项目自动分解为可管理的任务树，并深度集成 Proma 的 Task 系统。

**核心功能**：
- 🎯 智能任务拆解 - 将复杂项目分解为 1-4 小时可完成的原子任务
- 📋 侧边栏 TODO 集成 - 任务自动显示在 Agent 侧边栏 Task Board
- 🔗 依赖关系管理 - 自动识别任务前置依赖，设置阻塞关系
- 🤖 Agent 匹配推荐 - 为每个任务推荐最适合的工具
- ✏️ 动态任务管理 - 支持实时增删改查任务

**作者**: cyxhappy9858@163.com

**查看详情**: [docs/community-skills/taskpilot/](./docs/community-skills/taskpilot/)
